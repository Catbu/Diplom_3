...
public class RegistrationTest {
    ...
    public void registrationUserTest() {
        ...
        String email = "Catburger" + faker.name().firstName() + "@gmail.com";
    ...
    public void errorIncorrectPasswordTest() {
        registrationPage.inputName("Nastya" + faker.name().lastName());
        registrationPage.inputEmail("Catburger" + faker.name().firstName() + "@gmail.ru");
